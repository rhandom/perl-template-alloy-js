...
var Alloy = function () {}, md5_hex, $_vm, $item, $list, $hash, $blocks = {}, $docs = {}, $eval_recurse = 0;
...
setBlocks: function (blocks) {
  for (var i in blocks) {
    if (this.oldBScope && !this.oldBScope[0].hasOwnProperty(i)) this.oldBScope[0][i] = $blocks[i];
    $blocks[i] = blocks[i];
  }
},
