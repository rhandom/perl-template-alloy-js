...
call_native: function () {
  ...
  if (r && typeof r === "object" && r.hasOwnProperty("_call_native_error")) this.throw.apply(this, r._call_native_error);
  return r;
},
...
//}
    throw "ouch";
    return this.call_native.apply(this, args);
},
