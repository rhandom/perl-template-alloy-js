...
var Alloy = function () {}, md5_hex, $in = {}, $_vmethods, $item, $list, $hash, $blocks = {}, $docs = {}, $eval_recurse = 0, $scopeVars, $scopeConfig, $scopeBlocks;
...
load_vm: function () {
  if ($_vmethods) return $_vmethods;
  var ref = this.call_native('load_jslib', 'vmethods')
  if (typeof ref === 'string') { eval(ref) } else $_vmethods = ref;
