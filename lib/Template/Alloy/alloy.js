...
process_s: function (str, args) {
  ...
  var err;
  var undo = {};
  if (!this.hasOwnProperty('_eval_recurse')) this._eval_recurse = 0;
  if (++this._eval_recurse > $_env.MAX_EVAL_RECURSE) this.throw('eval_recurse', "MAX_EVAL_RECURSE "+$_env.MAX_EVAL_RECURSE+" reached");
  try {
