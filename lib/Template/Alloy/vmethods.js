...
var $_hash = {
  ...
  list:    null,
  new:     function (h) { if (arguments.length == 1 && h == 'object') return h; h={}; for (var i = 0; i < arguments.length; i+=2) h[arguments[i]] = arguments[i+1]; return h },
...
$_hash['list'] = function (h, what) {
    if (what == 'null' || !/^(keys|values|each|pairs)$/.test(what)) what = 'pairs';
    return $_hash[what](h);
}
